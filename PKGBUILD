...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/9e7a27b76730ca7fe4aecaeafc58bac1e2c82121/linux/x64/Cursor-2.0.75-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('4cd38e30023cdb633ece84a0cd298acf2859146454bc42403a41a65d5cf571899f149334376eadf0b6aa49cae135f4db2a506501f4ab60f54c63f2fc51099dfe'
