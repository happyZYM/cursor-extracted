...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/60d42bed27e5775c43ec0428d8c653c49e58e26a/linux/x64/Cursor-2.1.39-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('cd60f8ec15b031930ccbca314052dc93e29d2adaa64ec1a4e53b15b219683838a65134cc36ee53a987227ab20a6ce087fa3d75fb72ba933d1407097bc838f359'
