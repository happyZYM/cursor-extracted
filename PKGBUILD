...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/aece02022292184bb34fa0c899a97928489b7b78/linux/x64/Cursor-1.5.3-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('fd881488577695fb5632514fc5daf363ad4fd09bda74c5e3eb277aabfef0e468d6db5570583f2a8e7f6f550127d08a795ad1cce01d10b95485803cd07c1d9791'
