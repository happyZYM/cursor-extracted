...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/bb2dbaacf30bb7eb9fd48a37812a8f326defa533/linux/x64/Cursor-2.3.15-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('589525b6e56285d228fa3119a95da9ac55d7e74be7dcbf8a9939e1435f0416956a7b10fa75735cd4284f05f4a7e69a7f5a9d62ab41f6d9461b6704c6d9ba34e8'
