...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/e50823e9ded15fddfd743c7122b4724130c25df8/linux/x64/Cursor-1.4.3-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('06eaaea9c9b4be407a73c8839ba8a9bbb19020a0bb39e36b84e721a112dfaeabe543314e2cd6e2a11a1c75fb0d6420a02f690bba6a4f438ca7dd1a98296cbf7f'
