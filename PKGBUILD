...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/429604585b94ab2b96a4dabff4660f41d5b7fb8f/linux/x64/Cursor-1.7.25-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('af03441f1dfa988f4ceef3b920875284e39ed42be3afdffbee38a1f803e503a0f7d866479a5c064e69c567d7ee3e0c32743be72fc21876ef3bf3e6f75d91a6ca'
