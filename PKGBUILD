...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/faa03b17cce93e8a80b7d62d57f5eda6bb6ab9fa/linux/x64/Cursor-1.2.2-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('5b32bdf674e5ed4997715572673eb16e6f9a63398ed09de1f80fdfdd307ece7eb1098e7469c6977dbbe96df841540fc440d2ec760e393d5d9d77512ec6233e9d'
