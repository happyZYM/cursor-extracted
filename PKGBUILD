...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/3af362bc7c6ffdde67ee75328bc9be679d6f3a45/linux/x64/Cursor-1.2.3-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('139ccb513c568923ecb8e7eb80f87be251b235675a29272fc096856fd68aef157a68c85cc5e94cb9f09afb19662bc0b583f47c9effd16a2634946d75dbf0a56c'
