...
source_x86_64=("${_appimage}::https://downloads.cursor.com/production/eecab7538820b6470389330d2cca30b703322294/linux/x64/Cursor-2.3.9-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
sha512sums_x86_64=('e90ebc3c6afd3700487b0f848ee8df18920fb24d69290a71d82b06c7001d124b51cd6bfbfd12d2fec8e124bd6bd3835b3decbec3bd8430ee77cbde116e48b39d'
